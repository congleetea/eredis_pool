...
poolboy:
https://github.com/congleetea/poolboy (fork from https://github.com/comtihon/poolboy)

==Setup

 $ git clone git://github.com/congleetea/eredis_pool.git
 $ cd eredis_pool
 $ make get-deps
 $ make
...
cd eredis_pool && erl -pa ebin -pa ./deps/*/ebin
